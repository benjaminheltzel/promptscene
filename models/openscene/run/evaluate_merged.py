...
from point_loader import Point3DLoader, collation_fn_eval_all_merged
...
def evaluate(model, val_data_loader, labelset_name='scannet_3d'):
    ...
    #save_dir = os.path.join(args.save_folder, f"run_{time_stamp}")
    ...
    #    saved_feature_folder = os.path.join(args.save_folder, 'saved_feature')
